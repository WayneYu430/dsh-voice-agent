/** Package invariant companion. @module @wayneyu430227/dsh-voice-assistant/invariant */
...
export const apply = (ctx: Context): Promise<() => void> => Promise.resolve(ctx.invariants.register('@wayneyu430227/dsh-voice-assistant', install))
